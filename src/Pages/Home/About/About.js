        ...
        <div className="hero my-20">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='w-1/2'>
                    ...
                    <p className="py-6 font-normal ">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. <br /> <br />
